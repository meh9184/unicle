...
var examples = {
  'web-tech': {
    ...
    option: '{\n' +
            '  gridSize: 18,\n' +
            '  weightFactor: 3,\n' +
            '  fontFamily: \'Hanna, serif\',\n' +
            '  color: function() {\n' +
            '    return ([\'#0000ff\', \'#009999\', \'#003366\', \'#6699cc\', \'#000066\'])[Math.floor(Math.random() * 5)]\n' +
            '  },\n' +
            '  click: function(item) { var itemList = preItem + item[0]; location.replace("./index3.jsp?item="+ escape(encodeURIComponent(itemList)) );},\n' +
            '  hover: window.drawBox,\n' +
            '  backgroundColor: \'#ffffff\'\n' +
            '}',
    fontCSS: '//fonts.googleapis.com/earlyaccess/hanna.css',
    height: 470
  },
