...
var examples = {
  'web-tech': {
    ...
    option: '{\n' +
            ...
            '  },\n' +
            '  click: function(item) { location.href("./index3.jsp?item="+ escape(encodeURIComponent(item[1])) );},\n' +
  ...
  'les-miz': {
    ...
    option: '{\n' +
          ...
          '  },\n' +
          '  hover: window.drawBox,\n' +
          '  click: function(item) { location.href("./index3.jsp?item="+ escape(encodeURIComponent(item[0])) );},\n' +
          '    alert(item[0] + \': \' + item[1]);\n' +
          '  },\n' +
          '  backgroundColor: \'#333\'\n' +
          '}',
