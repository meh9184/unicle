...
0;
  ...
  <script type="text/javascript">
	...
	BasicDBObject query = new BasicDBObject("news", "total").append("code","20150525_result");
	BasicDBObject fields = new BasicDBObject("count", 1).append("word", 1);
...
%>	
		...
		%>
  		...
  		var Keyword = '<%=Keyword%>';
  		var Check = '황교안 총리 일 북한 혁신 야당 박근혜 김상곤 김무성 위원장 개성 법무장관 공단 청문회 정부';
	</script>
