...
<body>
	...
	<div class="container">
		...
		<p class="lead_s" align="center">
			<strong><font color="red" size=6>"정종우"</font> 탐색어 추이 </strong>
		</p>
	</div>
...
<div id="LineIdDiv" align="left">
    <fc:render chartId="LineId" swfFilename="msline" width="60%" height="400"
        debugMode="false" registerWithJS="false" xmlUrl="Data/lineData.xml"
        renderer="javascript" windowMode="transparent" />

<span id="PieIdDiv" align="right">
    <fc:render chartId="PieId" swfFilename="pie3d" width="500" height="350"
        debugMode="false" registerWithJS="false" xmlUrl="Data/pieData.xml"
        renderer="javascript" windowMode="transparent" />
